...
<br>
        <main>
            ...
            <a href="#DashProPromo"><img style="width: 75%; height: 75%;" src="Kiwi_Smartphone_Dash_Pro_Banner_Image.png"></a> <br> <br>

            <h1 style = "text-align: center;"> BLEND REALITY </h1> 
            <h2 style = "text-align: center;"> Kiwi's most powerful device mixes together all-day battery, 
            game-shattering performance, and connectivity to all of your favorite app. No compromises to a 
            faster, better tomorrow. </h2> <br> <hr>
            
            <br><br>

            <h2 style = "text-align: center;"> Starting at $899.99 USD </h2> <br> <br>

            <form style = "text-align: center; font-size: 24px;" action = "https://youtu.be/klfT41uZniI">
